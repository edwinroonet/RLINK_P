...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		//
		//		return ( Session[ "IsAuthorized" ] != null && (bool)Session[ "IsAuthorized" ] ==ue );
		//
