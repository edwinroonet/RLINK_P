...
FCKTextColorCommand.prototype._CreatePanelBody = function( targetDocument, targetDiv )
{
	...
	oDiv.innerHTML =
		'<table cellspacing="0" cellpadding="0" width="100%" border="0">\
			<tr>\
				...
				<td width="100%">' + FCKLang.ColorAutomatic + '</td>\
			</tr>\
		</table>' ;
	...
	if ( FCKConfig.EnableMoreFontColors )
	{
		...
		oDiv.innerHTML = '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td nowrap>' + FCKLang.ColorMoreColors + '</td></tr></table>' ;
